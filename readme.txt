...
Around line 28-32 there is a resource tag that defines what files are in the package and which one
should be the start when the learning management system (LMS) launches the package
(our LMS is Looop but there are plenty of others on the market).
...
Wrapping the contents of the Course_1 folder up as a zip (as it is in the folder here)
